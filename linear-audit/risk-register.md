...
**Owner:** Chad
**Review cadence:** Quarterly, or within 5 business days after any security assessment / incident
...
> total. The table below groups them by the 17 distinct package-level risk areas;
> those 17 packages collectively account for the 42 HIGH findings through multiple
> CVEs per package and transitive dependency hits. The remaining Trivy output is
> duplicate reporting of the same underlying packages.

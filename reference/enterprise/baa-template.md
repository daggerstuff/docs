...
**Pixelated Empathy — HIPAA Business Associate Agreement**

Version 1.0 · Effective Date: _[To be set upon execution]_
...
health information as defined by 45 CFR §160.103, including demographic
information, medical records, and payment information that identifies an
individual and relates to their past, present, or future physical or mental
health condition, healthcare provision, or payment for healthcare.

**"Electronic Protected Health Information" or "ePHI"** means PHI that is
created, stored, transmitted, or received electronically.
...
privacy of the PHI, as defined by 45 CFR §160.402.
...
with system operations in an information system, as defined by 45 CFR §164.304.
...
(c) As required by law, provided that Business Associate notifies Covered Entity
within 2 business days of receiving any legal request for PHI.
...
(c) Sell PHI to any third party.

(d) Use PHI for any purpose not expressly authorized by this Agreement or
required by law.
...
(d) Make available PHI in accordance with 45 CFR §164.524 (individual access
rights) and §164.526 (amendment rights).

(e) Make its internal practices, books, and records relating to the use and
disclosure of PHI received from, or created or received on behalf of, Covered
Entity available to the Secretary of HHS for purposes of determining Covered
Entity's compliance with the Privacy Rule.

(f) Return or destroy all PHI received from, or created or received on behalf
of, Covered Entity at the termination of this Agreement, as specified in
Section 10.

(g) Ensure that any Subcontractors that create, receive, maintain, or transmit
ePHI on behalf of Business Associate agree to the same conditions and
requirements that apply to Business Associate under this Agreement.

### 4.2 Security Rule Compliance

Business Associate shall comply with the HIPAA Security Rule (45 CFR Part 164,
...
- Information access management (access control, access establishment).
- Security awareness and training (security reminders, phishing protection).
- Security incident procedures (response, reporting, documentation).
...
(a) Notify Covered Entity of any Breach of Unsecured PHI within **seventy-two
...
- Actions taken to mitigate the Breach and prevent future breaches.
- Contact information for Business Associate's breach response team.

(c) Cooperate with Covered Entity in providing Breach notifications to
...
(a) Make reasonable efforts to limit PHI to the minimum necessary to accomplish
...
### 6.2 Subcontractor Breach Liability

Business Associate is responsible for the acts and omissions of its
Subcontractors that would constitute a Breach if committed by Business
Associate.
...
### 7.1 Covered Entity Audit Rights

Covered Entity (or its designated auditor) may audit Business Associate's
...
This Agreement is effective as of the Effective Date and continues until:

(a) The Underlying Agreement is terminated; or

(b) This Agreement is terminated in accordance with Section 8.2; or

(c) Business Associate has returned or destroyed all PHI as specified in
Section 10.
...
(c) Business Associate becomes the subject of a regulatory enforcement action
related to PHI.
...
(a) Business Associate shall return or destroy all PHI as specified in
Section 10.
...
parties. If any provision of this Agreement is determined to be invalid or
unenforceable, the remaining provisions shall continue in full force and effect.

### 9.3 Governing Law

This Agreement shall be governed by the laws of the State of [State], without
...
This Agreement, together with the Underlying Agreement, constitutes the entire
...
### 10.2 Destruction Certification

If Business Associate destroys PHI, it shall provide Covered Entity with a
written certification of destruction that includes:

(a) A description of the PHI destroyed (categories of PHI, number of records).

(b) The method of destruction (secure deletion, cryptographic erasure, physical
destruction).

(c) The date of destruction.

(d) A statement that all PHI has been destroyed and no copies remain.

(e) The name and signature of the authorized representative of Business
Associate.

### 10.3 Backup Retention

Notwithstanding Section 10.1, Business Associate may retain PHI in backup
archives for up to six (6) years following termination, provided that:

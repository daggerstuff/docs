...
3 skills used: `brainstorming` (pipeline mapping), `ai-engineer` (LLM architecture), `find-skills`
(+ NVIDIA NeMo `nemo-automodel-distributed-training`, 1.8K installs).

Assumption: greenfield (no prior pipeline assets in repo), domain-specialized + general branch support
(Option E from brainstorming gate).

...
(placeholder), SDG seed file (50 seeds, below 200 target).

**Not built / fiction:** FSDP2/Megatron distributed training (NeMo App A), real
GPU run, real catastrophic-forgetting eval (no GPU run), Axolotl Qwen/Llama
config.

**Contradicts preferences:** Llama 3.3/3.2 in §1, §5, §6, App C, action plan,
dual-judge secondary.

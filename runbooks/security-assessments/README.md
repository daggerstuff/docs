...
1. **Assessment metadata** — date range, environment (staging/prod), tester, methodology
2. **Executive summary** — headline numbers (Critical/High/Medium/Low), risk posture
...
6. **Compliance evidence pointers** — links to risk register and findings register

...
description: 'How Pixelated Empathy detects, scores, and escalates crisis signals during training sessions — five categories, five risk levels, and contextual severity modifiers.'
---
...
<Warning>
  **In real clinical practice**, crisis assessment requires comprehensive clinical judgment beyond pattern matching. The platform's crisis detection is designed for *training purposes* — helping therapists practise recognising and responding to crisis signals. It should never be used as the sole basis for clinical decision-making with real patients.
</Warning>
